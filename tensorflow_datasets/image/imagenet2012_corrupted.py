...
_IMAGE_SIZE = 224
_CROP_PADDING = 32
_RESIZE_METHOD = tf.image.resize_bicubic
...
def _decode_and_center_crop(image_bytes):
  ...
  image = _RESIZE_METHOD([image], [_IMAGE_SIZE, _IMAGE_SIZE])[0]
  ...
  def _info(self):
    ...
    return tfds.core.DatasetInfo(
        ...
        features=tfds.features.FeaturesDict({
            'image':
                tfds.features.Image(
                    shape=(224, 224, 3), encoding_format='jpeg'),
            'label':
